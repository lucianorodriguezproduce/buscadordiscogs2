...
export default function Home() {
    ...
    return (
        <div className="max-w-4xl mx-auto py-12 md:py-20 space-y-20 px-4">
            {/* Header Industrial */}
            <header className="space-y-4 text-center md:text-left">
                <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
                    <div className="h-2 w-2 bg-primary animate-pulse rounded-full" />
                    <span className="text-[10px] font-black uppercase tracking-[0.4em] text-primary/60">Sistema de Intención v3.0</span>
                </div>
                ...
                <div className={`space-y-12 transition-opacity duration-500 ${step === 2 ? 'opacity-30 pointer-events-none' : 'opacity-100'}`}>
                    ...
                    <div className="space-y-6">
                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 flex items-center gap-2 px-4">
                            <Layers className="h-3 w-3" /> Seleccionar Formato
                        </label>
                    ...
                    <div className="space-y-6">
                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 flex items-center gap-2 px-4">
                            <Package className="h-3 w-3" /> Estado de la Obra
                        </label>
                        <div className="flex flex-wrap gap-3">
                            <button
                                type="button"
